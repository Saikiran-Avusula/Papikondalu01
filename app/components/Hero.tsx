      ...
      <div className="relative z-10 text-center text-white max-w-6xl mx-auto container-padding">
        ...
        >
            ...
            <div className="space-y-4">
              ...
              <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold text-white leading-tight px-4">
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl p-3 sm:p-4 text-center hover:bg-white/30 transition-all duration-300 transform hover:-translate-y-1 shadow-lg"
                  >
                    <Icon className="mx-auto mb-2 text-secondary-400" size={20} />
                    <div className="text-base sm:text-lg font-bold text-white">{stat.label}</div>
            ...
            >
              <Link href="/packages" className="btn-primary group text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto">
                Explore Packages
              ...
              <button
                ...
                className="btn-outline group bg-white/10 backdrop-blur-md border-white/30 text-white hover:bg-white hover:text-neutral-900 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto"
              >
            ...
            <motion.div
              ...
              className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 pt-8 text-white/80 px-4"
            >
              <div className="text-xs sm:text-sm">✓ Certified by Tourism Board</div>
              <div className="text-xs sm:text-sm">✓ 24/7 Customer Support</div>
            </motion.div>
          </motion.div>
      </div>
